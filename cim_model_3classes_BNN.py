...
def main():
	train_set = DatasetFolder("3classes_lepton_bg/train", loader=lambda x: Image.open(x), extensions="bmp", transform=train_tfm)
	test_set = DatasetFolder("3classes_lepton_bg/test", loader=lambda x: Image.open(x), extensions="bmp", transform=test_tfm)
	val_set =  DatasetFolder("3classes_lepton_bg/train", loader=lambda x: Image.open(x), extensions="bmp", transform=test_tfm)
